...
class SettingsViewModel(
    shouldEnableChatPushNotifications: Boolean,
    shouldEnableEventsPushNotifications: Boolean,
    val avatarImage: String
) : KhameleonViewModel() {

    val version = BuildConfig.VERSION_NAME
    val shouldEnableChatPushNotifications = ObservableBoolean(shouldEnableChatPushNotifications)
    val shouldEnableEventsPushNotifications = ObservableBoolean(shouldEnableEventsPushNotifications)
}